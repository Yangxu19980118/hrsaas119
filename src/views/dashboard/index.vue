  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imgerror="require('@/assets/common/img.jpeg')" :src="staffPhoto">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">{{ time }},{{ username }}，祝你开心每一天！</p>
            <p class="lastChild">{{ departmentName }} | {{ companyName }}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
...
export default {
  ...
  computed: {
    ...mapGetters([
      'username', 'staffPhoto', 'departmentName', 'companyName'
    ])
  },
  mounted() {
    this.getTimer()
